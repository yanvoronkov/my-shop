	...
	return (
		<header class="header center">
			<nav class="header_left">
				...
				<svg class="head__img_find" width="26" height="27" viewBox="0 0 26 27" fill="none"
					xmlns="http://www.w3.org/2000/svg">
					<path
			...
			<nav class="header_right">
				<svg class="head__img_burger" width="32" height="23" viewBox="0 0 32 23" fill="none"
					xmlns="http://www.w3.org/2000/svg">
					<path d="M0 23V20.31H32V23H0ZM0 12.76V10.07H32V12.76H0ZM0 2.69V0H32V2.69H0Z" fill="#E8E8E8" />
				</svg>
				<nav class="hover_menu">
					<h2 class="hover_menu_title">MENU</h2>
					<h3 class="hover_menu_subtitle">MAN</h3>
					<ul class="hover_menu_chapter">
						<li class="hover_menu_paragraph">Accessories</li>
						<li class="hover_menu_paragraph">Bags</li>
						<li class="hover_menu_paragraph">Denim</li>
						<li class="hover_menu_paragraph">T-Shirts</li>
					</ul>
					<h3 class="hover_menu_subtitle">WOMAN</h3>
					<ul class="hover_menu_chapter">
						<li class="hover_menu_paragraph">Accessories</li>
						<li class="hover_menu_paragraph">Jackets & Coats</li>
						<li class="hover_menu_paragraph">Polos</li>
						<li class="hover_menu_paragraph">T-Shirts</li>
						<li class="hover_menu_paragraph">Shirts</li>
					</ul>
					<h3 class="hover_menu_subtitle">KIDS</h3>
					<ul class="hover_menu_chapter">
						<li class="hover_menu_paragraph">Accessories</li>
						<li class="hover_menu_paragraph">Jackets & Coats</li>
						<li class="hover_menu_paragraph">Polos</li>
				...
				<a href="/registration">
					<svg class="head__img_login" width="29" height="29" viewBox="0 0 29 29" fill="none"
						xmlns="http://www.w3.org/2000/svg">
						<path
				...
				<a href="/shoppingcart">
					<div class="header_right_basket">
						<svg class="head__img_basket" width=" 32" height="29" viewBox="0 0 32 29" fill="none"
							xmlns="http://www.w3.org/2000/svg">
							<path
